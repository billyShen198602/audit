...
@Configuration
//指定扫描的mapper接口所在的包
@MapperScan(basePackages = "com.demo.generator", sqlSessionFactoryRef = "DBDataSqlSessionFactory")
public class DataSourceConfig {
	...
	public SqlSessionFactory  sqlSessionFactory(@Qualifier("DBDataSource") DataSource dataSource)
		...
		bean.setMapperLocations(
				new PathMatchingResourcePatternResolver().getResources("classpath*:com/demo/generator/*.xml"));
