...
public class CustomXWPFDocument extends XWPFDocument {  
    ...
    public void createPicture(int id, int width, int height,XWPFParagraph paragraph) {  
        ...
        width *= EMU;  
        height *= EMU;
        List<XWPFPictureData> pictureDataList = getAllPictures();
        XWPFPictureData xwpfPictureData = getAllPictures().get(id);
        String blipId = xwpfPictureData.getChecksum().toString();
